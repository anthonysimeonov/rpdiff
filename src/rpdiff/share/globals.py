...
from rpdiff.utils.path_util import get_rpdiff_assets
...
bad_shapenet_mugs_data = np.load(osp.join(get_rpdiff_assets(), 'bad_mugs_all.npz'))
bad_shapenet_bowls_data = np.load(osp.join(get_rpdiff_assets(), 'bad_bowls.npz'))
bad_shapenet_bottles_data = np.load(osp.join(get_rpdiff_assets(), 'bad_bottles_all.npz'))
