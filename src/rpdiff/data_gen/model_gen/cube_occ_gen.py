...
parser.add_argument('--centered_save_dir', type=str, default='cuboids_centered')
...
datadir = osp.join(path_util.get_eof_obj_descriptions(), args.datadir)
occ_savedir = osp.join(path_util.get_eof_obj_descriptions(), args.occ_save_dir)
centered_savedir = osp.join(path_util.get_eof_obj_descriptions(), args.centered_save_dir)
