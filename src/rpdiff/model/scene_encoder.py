...
from rpdiff.model.encoder.layers import ResnetBlockFC
from rpdiff.model.encoder.common import coordinate2index, normalize_coordinate, normalize_3d_coordinate, map2local
from rpdiff.model.encoder.common import make_3d_grid
from rpdiff.model.encoder.unet import UNet
from rpdiff.model.encoder.unet3d import UNet3D
...
class LocalPoolPointnet(nn.Module):
    ...
    def forward(self, p):
        ...
        if False:
            ...
            # raster_pts = make_3d_grid((-0.55, -0.55, -0.55), (0.55, 0.55, 0.55), (self.reso_grid, self.reso_grid, self.reso_grid))[None, :, :].repeat(batch_size, 1, 1).numpy()
